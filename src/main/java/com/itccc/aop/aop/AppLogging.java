...
public class AppLogging {
    ...
    @Before(value = "execution(* com.itccc.aop.service.EmployeeService.*(..)) && args(employee)")
    ...
    @After(value = "execution(* com.itccc.aop.service.EmployeeService.*(..)) && args(employee) ")
    ...
    @Pointcut("execution(public * com.itccc.aop.service.*.*(..))")
    public void logApp() {
    }
    ...
    //    @Around("logApp()")
    @Around("execution(public * com.itccc.aop.service.*.*(..)) && @annotation(com.itccc.aop.aop.Log)")
